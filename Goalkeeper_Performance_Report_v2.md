...
<style>
.improve-box { background:#f3eefc; border-left:5px solid #8e44ad; border-radius:8px; padding:14px 18px; margin:10px 0; }
.improve-box h3 { margin-top:0; color:#6c3483; }
.improve-list { margin:0; padding-left:20px; }
.improve-list li { margin-bottom:8px; font-size:1.05rem; }
</style>
